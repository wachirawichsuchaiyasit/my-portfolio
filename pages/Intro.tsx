...
export default function IntroHome() {
    return (
        <>
            <div className="h-screen w-screen  bg-[#E5D6C2]">
                <div className="h-screen w-screen grid gap-5">
                    ...
                    <div className="w-full container mx-auto p-5 ">
                        ...
                        <div className="w-full  h-full flex items-center justify-center ">
                            <Image src={"/image/logo.png"} width={1200} height={1000} alt="" className="lg:w-[1200px]" />
                        </div>

                    </div>


                    <div className="w-full container mx-auto items-center   relative grid lg:grid-cols-2">
